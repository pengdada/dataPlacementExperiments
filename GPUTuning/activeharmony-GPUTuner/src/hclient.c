...
int ah_report(htask_t* htask, double* perf)
{
    ...
    /* @Abdullah, @Test*/
    fprintf(stderr, "ah_report-2\n");

    if (htask->mesg->status != HMESG_STATUS_OK)
        return -1;

    /* @Abdullah, @Test*/
    fprintf(stderr, "ah_report-3\n");
